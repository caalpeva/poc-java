...
public class NamedParameterJdbcPersonDaoSupport extends NamedParameterJdbcDaoSupport implements PersonDao {
	...
	private int queryForIdentity() {
		Map<String, Object> parameters = new HashMap<String, Object>();
		return new Integer(getNamedParameterJdbcTemplate().queryForInt("call identity()", parameters));
	}
	...
	public Person getPersonById(Integer id) {
		...
		List matches = getNamedParameterJdbcTemplate().query(PERSON_BY_ID_SELECT, parameters, new RowMapper() {
	...
	public List<Person> list() {
		Map<String, Object> parameters = new HashMap<String, Object>();
		return getNamedParameterJdbcTemplate().query(PERSON_SELECT, parameters, new RowMapper() {
			public Object mapRow(ResultSet result, int rowNums) throws SQLException {
				Person person = new Person();
				person.setId(result.getInt(1));
				person.setFirstName(result.getString(2));
